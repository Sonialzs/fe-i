					...
					function validateOptions(opts) {
						Object.keys(opts).forEach((key) => {
							if (!DEFAULTS.hasOwnProperty(key)) {
								throw new Error(
									'prettyFormat: Invalid option: ' + key
								);
							}
						});
						...
						if (
							...
							throw new Error(
								'prettyFormat: Cannot run with min option and indent'
							);
						}
					}
